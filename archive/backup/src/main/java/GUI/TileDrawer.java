...
public class TileDrawer {
    ...
    */
    public void draw(Graphics g, int number, TileType t,boolean selected){
        calculatePoints();
        ...
        if(selected) {
            g.drawRect(x, y, (2*WIDTH_BETWEEN_2_TILES + WIDTH_TILE)*scale, 2*Y_BETWEEN_2_TILES*scale);
        }
     ...
     */
    public void draw(Graphics g, ITile tile){

        draw(g,tile.getNumber(),tile.getType(),false);
