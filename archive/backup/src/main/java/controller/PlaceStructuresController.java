...
public class PlaceStructuresController extends StandardController{   
    ...
    /**
     * Constructor
     * @param placeNumbersController controller om nummers te plaatsen
     */
    public PlaceStructuresController(PlaceNumbersController placeNumbersController) {
        setBoard(placeNumbersController.getBoard());
    }
